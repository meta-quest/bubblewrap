...
type Messages = {
  ...
  promptMicrophonePermission: string;
  ...
  promptXrScenePermission: string;
...
\t\t- To open ${italic('https://example.com/path-to-pwa/')}: ${cyan('/path-to-pwa/')}\n`,
  ...
  promptHorizonOSAppMode: 'App mode for your PWA in Meta Horizon OS?',
  ...
  promptApplicationId: 'Meta Horizon Application ID:',
  ...
  promptMicrophonePermission: 'Request microphone permission?',
  ...
  promptXrScenePermission: 'Request XR Scene (USE_SCENE) permission? It is required for WebXR Depth and Anchors usage.',
  warnFamilyPolicy:
